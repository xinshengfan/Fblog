    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-10">
            <ol class="breadcrumb header">
                <li><span class="icon glyphicon glyphicon-hoem"></span> 主菜单</li>
                <li class="active">文章</li>
            </ol>
            <div class="panel panel-default">
                <div class="panel-heading"><span class="icon glyphicon glyphicon-list"></span>文章列表</div>
                <div class="panel-body">
                    <table class="table table-striped list-table" id="post-table">
                        <thead>
                        <tr>
                        ...
                        <c:forEach items="${page.content}" var="post">
                          ...
                          <i class="post-cs">${post.cstatus}</i><i class="post-tags">${z:join(post.tags,',')}</i></span>
                                ...
                                <td class="center"><span class="icon glyphicon glyphicon-pencil pointer"
                                                         onclick="fblog.post.edit('${post.id}')"></span>
                                    <span class="glyphicon glyphicon-trash pointer"
                                          onclick="fblog.post.remove('${post.id}')"></span></td>
                            </tr>
                        </c:forEach>
                        <tr id="edit-row">
                            <td colspan="6">
                                <div class="edit-col-left">
                                    <h5>快速编辑</h5>
                                    <span><label>标题</label><input type="text" name="title"
                          ...
                          <input type="radio" name="pstatus" value="secret">隐藏</span>
                           ...
                           <input type="radio" name="cstatus" value="close">否</span>
                                ...
                                <p>
                                    <button class="btn btn-default btn-sm" onclick="fblog.post.canclefast();">取消
                                    </button>
                                    <button style="float:right;" class="btn btn-primary btn-sm"
                                            onclick="fblog.post.submitfast();">更新
                                    </button>
                                </p>
                            </td>
                        </tr>
