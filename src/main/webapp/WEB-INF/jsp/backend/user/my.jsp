                ...
                <div class="panel-body">
                    <form action="my" method="post" class="form-horizontal text-left" role="form">
                        ...
                        <div class="form-group ${email!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="email" type="text" name="email" value="${my.email}"/>
                        ...
                        <div class="form-group ${realName!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="realName" autocomplete="off" name="realName" type="text"
                                       value="${my.realName}"/>
                        ...
                        <div class="form-group ${password!=null?'has-error':''}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input style="margin-top: 5px;" class="form-control input-sm" type="password"
                                       name="repass"/>
