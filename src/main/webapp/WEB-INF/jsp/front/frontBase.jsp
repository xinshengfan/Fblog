...
<meta name="keywords" content="FBlog,ios,android,web,note,博客,技术,xinping">
<meta name="description" content="FBlog is myself blog,use spring+mybatis+Bootstrap technology">
<meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no">
<meta http-equiv="X-UA-COMPATIBLE" content="IE=Edge,chrome=1">

<title>Xinping${ptitle!=null?' | ':''}${ptitle}</title>
...
<link rel="stylesheet" href="${g.domain}/resource/css/client_v1.2.css"/>
